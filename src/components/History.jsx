  ...
  return (
    <div className='px-4 sm:px-12 lg:px-24 xl:px-40 py-10' id='History'>
      <div className=''>
        ...
        <div className='mx-auto mt-7 font-bold text-center text-xl max-sm:text-sm border-b-2 border-gray-400 pb-10'>
          {" "}
          ...
          Federation and its Eastern Mediterranean regional office. Over the
          years, EPSF-BeniSuef has been recognized as the 2nd best-performing
          society in the Federation (2012–2013), the 3rd best (2014–2015), and
          the 4th best (2016–2017)."
        </div>
